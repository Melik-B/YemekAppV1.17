...
namespace YemekApp.Controllers
{
    ...
    public class YemekController : Controller
    {
        ...
        public IActionResult Create(YemekTarifiModel yemekTarifi)
        {
            ...
            //ViewBag.MalzemeId = new SelectList(_malzemeService.Query().ToList(), "Id", "Adi", yemekTarifi.MalzemeAdiDisplay);
        ...
        public IActionResult Edit(int? id)
        {
            ...
            if (model == null)
                return View("Hata", "Kayıt bulunamadı!");
            //ViewBag.MalzemeId = new SelectList(_malzemeService.Query().ToList(), "Id", "Adi", model.MalzemeAdiDisplay);
